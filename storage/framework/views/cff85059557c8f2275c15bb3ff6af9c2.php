  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <?php if(session('error')): ?>
            ...
            <?php endif; ?>
        <form action="<?php echo e(route('register.store')); ?>" method="POST" role="form text-left">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\projectiti\example5-app\resources\views/auth/register.blade.php ENDPATH**/ ?>